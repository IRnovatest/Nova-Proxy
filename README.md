...
| متغیر | توضیح | پیش‌فرض |
|---|---|---|
| `ADMIN_PASSWORD` | رمز عبور ورود به داشبورد وب | `irnova` |
...
Nova Proxy · پشتیبانی: [@Farajian2004f](https://t.me/Farajian2004f)
